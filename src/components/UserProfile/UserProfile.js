  ...
  return (
    <div>
      <div className="profile_container flex flex-row gap-80 my-0 ml-40 mb-20 ">
        ...
        <div>
          <div style={{ color: "white" }}>Name: {user?.displayName}</div>
          <div style={{ color: "white" }}>Email: {user?.email}</div>
          {
            data?.status?(<div style={{ color: "white" }}>status: true</div>): <div style={{ color: "white" }}>status: false</div>
          }
